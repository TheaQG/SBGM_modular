...
def evaluate_from_args():
    ...
    parser.add_argument('--LR_VARS', type=str2list_of_strings, default=['temp'], help='The low resolution variables. Write in format "var1,var2,var3"')
    ...
    parser.add_argument('--CUTOUT_DOMAINS', type=str2list, default=[170, 350, 340, 520], help='The cutout domains, write in pixels and format x1,x2,y1,y2')
    ...
    parser.add_argument('--data_split_params', type=str2dict, default={'train_size': 0.8, 'val_size': 0.1, 'test_size': 0.1}, help='The data split parameters')
