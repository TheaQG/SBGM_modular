...
CUTOUT_DOMAINS="[170,350,340,520]" #"[195,323,365,493]" # # 170, 170+180, 340, 340+180
...
SPECIFIC_FIG_NAME="test_with_prcp_temp_LR_HR_same_domain_with_shuffle'" # Name of the specific figure to save
